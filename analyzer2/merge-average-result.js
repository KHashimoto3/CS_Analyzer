...
const jsonDirectory = path.join(__dirname, "average-result-files");

// 出力ファイルのパスを指定
const outputFile = path.join(__dirname, "average-result-merged.json");
